...
<head>
    <title>Sistem Monitoring Kebugaran & Nutrisi</title>
    ...
    <div class="login-box">
        <div class="card card-outline card-primary">
            <div class="card-header">
                ...
                <h2 class="text-center">Sistem Monitoring Kebugaran & Nutrisi</h2>
            </div>
            ...
            <div class="card-footer">
                <p class="m-0 p-0">Copyright &copy; 2024 Rajwa Syafiq Ibrahim.</p>
            </div>
        </div>

...
<?php 
	...
	if ($delete_rekomendasi_makanan) {
        $log_berhasil = mysqli_query($conn, "INSERT INTO log VALUES ('', 'Rekomendasi Makanan $makanan berhasil dihapus!', CURRENT_TIMESTAMP(), " . $dataUser['id_user'] . ")");
		...
		echo "
	        <script>
	            Swal.fire({
	                icon: 'success',
	                title: 'Berhasil!',
	                text: 'Rekomendasi Makanan " . $makanan . " berhasil dihapus!'
	            }).then((result) => {
        ...
        $log_gagal = mysqli_query($conn, "INSERT INTO log VALUES ('', 'Rekomendasi Makanan $makanan gagal dihapus!', CURRENT_TIMESTAMP(), " . $dataUser['id_user'] . ")");
	    ...
	    echo "
	        <script>
	            Swal.fire({
	                icon: 'error',
	                title: 'Gagal!',
	                text: 'Rekomendasi Makanan " . $makanan . " gagal dihapus!'
	            }).then((result) => {
	                if (result.isConfirmed) {
	                    window.location.href = 'rekomendasi_makanan.php';
	                }
